...
for criterion, criterion_name in loss_functions:
    ...
    for epoch in range(NUM_EPOCHS):
        ...
        result_data['training_confusion'] = confusion.tolist()
        ...
        if (epoch + 1) % EVAL_INTERVAL == 0 or (epoch + 1) == NUM_EPOCHS:
            ...
            result_data['testing_acc'].append(train_acc)
            ...
            result_data['testing_confusion'] = confusion.tolist()
...
if not os.path.exists("record"):
    os.makedirs("record")
with open('record/results.json', 'w') as file:
