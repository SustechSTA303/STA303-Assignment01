...
parser.add_argument("--loss", type=str, default="ce", help="Loss") # ce mae focal0.5 focal2
...
match super_args.loss:
    ...
    case _:
        raise Exception("Wrong loss argument")
...
df.to_csv(f'./log/{super_args.model}_{super_args.loss}.csv', index=False)
print('log generated')